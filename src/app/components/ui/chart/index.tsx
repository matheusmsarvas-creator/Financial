...
import { cn } from "../../utils"; // Ajuste o caminho do utils
...
function ChartTooltipContent({
  ...
  return (
    <div className={cn(styles.tooltip, className)}>
      ...
      <div className={styles.tooltipItemGrid}>
                ...
                <>
                        ...
                        style={
                          {
                            ...
                            backgroundColor: indicatorColor, // Fallback para o dot/line
                  ...
                  <div
                    className={cn(
                      styles.tooltipRow,
                      nestLabel
                        ? styles.tooltipRowEnd
                        : styles.tooltipRowCenter,
                    )}
                  >
                    <div className={styles.tooltipItemGrid}>
                      {nestLabel ? tooltipLabel : null}
                      <span className={styles.tooltipTextMuted}>
