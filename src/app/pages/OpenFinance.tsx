      ...
      >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p style={{ color: "#94A3B8", lineHeight: 1.6 }}>
                  Utilizamos Open Finance, regulamentado pelo Banco Central.
                  Suas credenciais são criptografadas e nunca armazenadas. Você
                  tem controle total sobre quais dados compartilhar e pode
        ...
        {connectedBanks.length > 0 && (
          <motion.div
            ...
            className="mb-8"
          >
            <h2 className="mb-4" style={{ color: "#F8FAFC" }}>
              Contas Conectadas
            </h2>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 style={{ color: "#F8FAFC", fontSize: "16px" }}>
                            {bank.name}
                          </h3>
                          <p style={{ color: "#94A3B8", fontSize: "12px" }}>
                            Disponível
                ...
                <div className="space-y-4 mb-6">
                  ...
                  >
                    ...
                    >
                      ...
                      {selectedBank.name} para autorizar o acesso aos seus
                      dados.
                    </p>
                  </div>
