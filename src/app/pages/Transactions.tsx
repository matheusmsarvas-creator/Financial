...
import { Plus, TrendingUp, TrendingDown, Trash2, Filter, Calendar } from 'lucide-react';
      ...
      >
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p style={{ color: '#94A3B8' }}>Gerencie todos os seus lançamentos</p>
          </div>
          <button
        ...
        <div className="flex gap-4 mb-6">
          <button
            ...
            style={{
              ...
              boxShadow: filter === 'all' ? '0 0 20px rgba(59, 130, 246, 0.4)' : 'none',
            }}
          >
            Todas
          </button>
          <button
            ...
            style={{
              background: filter === 'income' ? '#10B981' : 'rgba(255, 255, 255, 0.08)',
              backdropFilter: 'blur(10px)',
              color: '#F8FAFC',
              border: filter === 'income'
                ? '1px solid rgba(255, 255, 255, 0.3)'
                : '1px solid rgba(255, 255, 255, 0.15)',
              boxShadow: filter === 'income' ? '0 0 20px rgba(16, 185, 129, 0.4)' : 'none',
            }}
          >
            Receitas
          </button>
          <button
            ...
            style={{
              background: filter === 'expense' ? '#EF4444' : 'rgba(255, 255, 255, 0.08)',
              backdropFilter: 'blur(10px)',
              color: '#F8FAFC',
              border: filter === 'expense'
                ? '1px solid rgba(255, 255, 255, 0.3)'
                : '1px solid rgba(255, 255, 255, 0.15)',
          ...
          >
            ...
            >
              <GlassCard className="p-6">
                <h2 className="mb-6" style={{ color: '#F8FAFC' }}>Novo Lançamento</h2>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      {categories[formData.type].map((cat) => (
                        <option key={cat} value={cat} style={{ background: '#0A0F24' }}>
                          {cat}
                        </option>
                      ))}
                    </select>
                  ...
                  <div>
                    ...
                    >
                      <option value="none" style={{ background: '#0A0F24' }}>Não se repete</option>
                      <option value="daily" style={{ background: '#0A0F24' }}>Diário</option>
                      <option value="weekly" style={{ background: '#0A0F24' }}>Semanal</option>
                      <option value="monthly" style={{ background: '#0A0F24' }}>Mensal</option>
                      <option value="yearly" style={{ background: '#0A0F24' }}>Anual</option>
                    </select>
                  </div>
