...
export function Goals() {
  ...
  const totalMonthlyDeposit = goals.reduce(
    (sum, g) => sum + g.monthlyDeposit,
    0,
  );
  ...
  const calculateMonthlyDeposit = (
    ...
    const monthlyPayment =
      (remaining * rate) / (1 - Math.pow(1 + rate, -months));
  ...
  const handleCalculate = () => {
    ...
    if (target && months && target > current) {
      const monthly = calculateMonthlyDeposit(
        target,
        current,
        months,
        calculator.interestRate / 100,
      );
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newGoal: Goal = {
      ...
      color: ["#3B82F6", "#10B981", "#06B6D4", "#8B5CF6", "#F59E0B"][
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            ...
            >
              ...
              >
                R${" "}
                {totalMonthlyDeposit.toLocaleString("pt-BR", {
                  minimumFractionDigits: 2,
                })}
              </p>
        ...
        <div className="space-y-6">
          {goals.map((goal, index) => {
            ...
            const isOnTrack =
              goal.currentAmount >=
              goal.targetAmount * (1 - monthsRemaining / 24);
            ...
            return (
              ...
              >
                <GlassCard
                  variant="default"
                  className="p-8 group hover:scale-[1.01] transition-all"
                >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCalculator({ ...calculator, months: e.target.value })
                      }
                      className="w-full px-4 py-3 rounded-xl"
                      style={{
                        background: "rgba(255, 255, 255, 0.08)",
                ...
                {calculator.monthlyDeposit > 0 && (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        R${" "}
                        {calculator.monthlyDeposit.toLocaleString("pt-BR", {
                          minimumFractionDigits: 2,
                        })}
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      >
                        ...
                        >
                          R${" "}
                          {calculator.totalDeposits.toLocaleString("pt-BR", {
                            minimumFractionDigits: 2,
                          })}
                        </p>
                      </div>
                      ...
                      >
                        ...
                        >
                          R${" "}
                          {(
                            parseFloat(calculator.targetAmount) -
                            parseFloat(calculator.currentAmount) -
                            calculator.totalDeposits
                          ).toLocaleString("pt-BR", {
                            minimumFractionDigits: 2,
                          })}
                        </p>
                    ...
                    >
                      ...
                      >
                        💡 <strong style={{ color: "#F8FAFC" }}>Dica:</strong>{" "}
                        Considere investir em uma aplicação com rendimento para
                        alcançar sua meta mais rápido. Com{" "}
                        {calculator.interestRate}% ao mês, você terá um ganho
                        estimado de R${" "}
                        {(
                          parseFloat(calculator.targetAmount) -
                          parseFloat(calculator.currentAmount) -
